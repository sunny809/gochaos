// Basic example
//
// This example demonstrates the simplest way to use gmock as an embedded
// HTTP mock server. It creates a server, registers a stub, makes a request,
...
func main() {
	...
	// Register a stub for GET /api/users
